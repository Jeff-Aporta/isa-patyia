...
function buildTreeFromFlatList(items, config) {
  ...
  for (const node of byPath.values()) {
    ...
    } else if (!hasKnownParent2(node.flatPath)) {
      roots.push(node);
    }
  }
  const sortRec = (list) => {
...
function RolePermissionsEditor(props) {
  ...
  const [editingValue, setEditingValue] = useState7("");
  useEffect7(() => {
    let cancelled = false;
    (() => {
      setLoading(true);
  ...
  const handlePromote = useCallback4(async (perm, targetJer) => {
    try {
  ...
  return /* @__PURE__ */ jsxs7(Box6, { className: "role-permissions-editor", sx: { display: "flex", flexDirection: "column", gap: 1.5, p: 2 }, children: [
    /* @__PURE__ */ jsxs7(Breadcrumbs, { separator: "\u203A", sx: { fontSize: 13 }, children: [
      pathAncestors.slice(0, -1).map((j) => /* @__PURE__ */ jsx10(Link, { underline: "hover", color: "inherit", children: j }, j)),
      /* @__PURE__ */ jsx10(Typography6, { color: "text.primary", fontWeight: 700, children: currentNode.jerarquia })
    ] }),
    /* @__PURE__ */ jsxs7(Stack5, { direction: "row", alignItems: "center", spacing: 1, children: [
      /* @__PURE__ */ jsx10(Typography6, { variant: "h6", sx: { flex: 1 }, children: currentNode.namedisplay ?? currentNode.iusuario }),
      /* @__PURE__ */ jsx10(Chip5, { size: "small", label: currentNode.jerarquia }),
      /* @__PURE__ */ jsx10(Button4, { onClick: onClose, size: "small", sx: { textTransform: "none" }, children: "Cerrar" })
    ] }),
    ...
    loading ? /* @__PURE__ */ jsx10(CircularProgress4, { size: 20 }) : /* @__PURE__ */ jsxs7(Stack5, { spacing: 0.5, children: [
      resolved.length === 0 ? /* @__PURE__ */ jsx10(Typography6, { variant: "body2", color: "text.secondary", sx: { p: 1 }, children: "Sin permisos." }) : null,
      resolved.map((perm) => /* @__PURE__ */ jsxs7(Box6, { sx: {
        p: 1,
        border: 1,
        ...
        /* @__PURE__ */ jsxs7(Stack5, { direction: "row", alignItems: "center", spacing: 1, children: [
          /* @__PURE__ */ jsxs7(Box6, { sx: { flex: 1, minWidth: 0 }, children: [
          ...
          perm.isInherited ? /* @__PURE__ */ jsxs7(Stack5, { direction: "row", alignItems: "center", spacing: 0.5, children: [
            /* @__PURE__ */ jsx10(Tooltip4, { title: `Viene de ${perm.ownerJerarquia} (no editable aqu\xED)`, children: /* @__PURE__ */ jsx10(Chip5, { size: "small", color: "warning", label: `\u{1F512} ${perm.ownerJerarquia}` }) }),
          ...
          ] }) : /* @__PURE__ */ jsxs7(Stack5, { direction: "row", alignItems: "center", spacing: 0.5, children: [
            /* @__PURE__ */ jsx10(Chip5, { size: "small", color: "primary", label: "local" }),
            editingKey === perm.key ? /* @__PURE__ */ jsxs7(Fragment5, { children: [
              /* @__PURE__ */ jsx10(Button4, { size: "small", onClick: saveEdit, disabled: busy, children: "Guardar" }),
              /* @__PURE__ */ jsx10(Button4, { size: "small", onClick: () => setEditingKey(null), children: "Cancelar" })
        ...
        perm.isInherited ? /* @__PURE__ */ jsxs7(Alert3, { severity: "warning", sx: { mt: 0.5, py: 0 }, icon: /* @__PURE__ */ jsx10("iconify-icon", { icon: "mdi:lock-outline", width: "16", height: "16" }), children: [
