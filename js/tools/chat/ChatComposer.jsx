    ...
    <Box className="paty-chat-compose">
      ...
      <Box className="paty-chat-input-wrap">
        ...
        <input
          ref={audioInputRef}
          type="file"
          accept="audio/webm,audio/mp4,audio/mpeg,audio/wav,audio/ogg,.webm,.mp3,.m4a,.wav,.ogg"
          multiple
          hidden
          aria-hidden
          tabIndex={-1}
          onChange={onAttachAudiosChange}
        />
        ...
        <Tooltip title="Adjuntar archivo de audio">
          <span>
            <IconButton color="inherit" className="paty-chat-audio-attach-btn" aria-label="Adjuntar audio" disabled={sending || audios.length >= MAX_CHAT_AUDIOS} onClick={onAttachAudiosClick} size="small">
